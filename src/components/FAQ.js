...
const FAQ = () => {
    const [faq, setFaq] = useState([
        {
            question: 'What is piezoelectricity?',
            answer: 'Piezoelectricity is the electric charge generated in certain materials when mechanical stress is applied to them.',
            open: false
        },
        {
            question: 'What is footstep power generation?',
            answer: 'Footstep power generation involves harnessing energy from footsteps using piezoelectric sensors, converting mechanical energy into electrical energy.',
            open: false
        },
        {
            question: 'What types of materials are used for piezoelectric sensors?',
            answer: 'Common materials include quartz, ceramics (like PZT - lead zirconate titanate), and certain polymers (like PVDF).',
            open: false
        },
        {
            question: 'What are the main applications of footstep power generation?',
            answer: 'Applications include powering low-energy devices (like sensors or LED lights), sustainable energy solutions for public spaces, and smart flooring systems.',
            open: false
        }
    ]);
